...
UserPreferences = dict[str, Preference]  # topic_id -> "liked" | "disliked"
...
def score_story(
    ...
    Args:
        story_topics:       list of topic_ids tagged on the story
        preferences:        user's liked/disliked topic_id map
